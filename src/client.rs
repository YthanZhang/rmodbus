...
macro_rules! parse_reg32_le {
    ($self: expr, $buf: expr, $result: expr, $t: ty) => {{
        ...
        while pos < data.len() - 3 {
            let value =
                <$t>::from_le_bytes([data[pos], data[pos + 1], data[pos + 2], data[pos + 3]]);
            if $result.len() >= usize::from($self.count) {
                break;
            }
            $result.push(value)?;
...
impl ModbusRequest {
    ...
    ///
    /// The input buffer SHOULD be cut to actual response length
    pub fn parse_u32_be<V: VectorTrait<u32>>(
        &self,
        buf: &[u8],
        result: &mut V,
    ) -> Result<(), ErrorKind> {
        parse_reg32_be!(self, buf, result, u32);
        Ok(())
    }
    ...
    ///
    /// The input buffer SHOULD be cut to actual response length
    pub fn parse_i32_be<V: VectorTrait<i32>>(
        &self,
        buf: &[u8],
        result: &mut V,
    ) -> Result<(), ErrorKind> {
        parse_reg32_be!(self, buf, result, i32);
        Ok(())
    }
    ...
    ///
    /// The input buffer SHOULD be cut to actual response length
    pub fn parse_f32_be<V: VectorTrait<f32>>(
        &self,
        buf: &[u8],
        result: &mut V,
    ) -> Result<(), ErrorKind> {
        parse_reg32_be!(self, buf, result, f32);
        Ok(())
    }
    ...
    ///
    /// The input buffer SHOULD be cut to actual response length
    pub fn parse_u32_le<V: VectorTrait<u32>>(
        &self,
        buf: &[u8],
        result: &mut V,
    ) -> Result<(), ErrorKind> {
        parse_reg32_le!(self, buf, result, u32);
        Ok(())
    }
    ...
    ///
    /// The input buffer SHOULD be cut to actual response length
    pub fn parse_i32_le<V: VectorTrait<i32>>(
        &self,
        buf: &[u8],
        result: &mut V,
    ) -> Result<(), ErrorKind> {
        parse_reg32_le!(self, buf, result, i32);
        Ok(())
    }
    ...
    ///
    /// The input buffer SHOULD be cut to actual response length
    pub fn parse_f32_le<V: VectorTrait<f32>>(
        &self,
        buf: &[u8],
        result: &mut V,
    ) -> Result<(), ErrorKind> {
        parse_reg32_le!(self, buf, result, f32);
        Ok(())
    }
